          ...
          <ScrollAnimation>
            <div className="text-center max-w-3xl mx-auto">
              ...
              <h1 className="section-heading mb-4">
                Meet the <span className="text-gradient-mars">Team</span>
              </h1>
              <p className="section-subheading mx-auto">
                The passionate engineers, scientists, and innovators behind Team
                Durbar. Explore our departments and meet the leaders driving our
                mission forward.
              </p>
            </div>
          </ScrollAnimation>
        ...
        <div className="section-container">
          <ScrollAnimation>
            <div className="text-center mb-12">
              ...
              <h2 className="section-heading mb-4">Departments</h2>
              <p className="section-subheading mx-auto">
                Five specialized teams working together to build world-class
                rovers
              </p>
            </div>
          </ScrollAnimation>
